 ...
 */
define("src/lib/animate-debug", [ "../tools/timer-debug", "../tools/util-debug", "../tools/observer-debug", "../tools/requestAnimationFrame-debug", "./core-debug", "../tools/easing-debug" ], function(require) {
    var Timer = require("../tools/timer-debug"), Animate = require("./core-debug"), tools = require("../tools/util-debug");
    function Animation() {
