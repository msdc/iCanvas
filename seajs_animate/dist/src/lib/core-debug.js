 ...
 *
 */
define("src/lib/core-debug", [ "../tools/util-debug", "../tools/observer-debug", "../tools/easing-debug" ], function(require) {
    var tools = require("../tools/util-debug"), observer = require("../tools/observer-debug"), /*log = require("../tools/log"),*/
    Tween = require("../tools/easing-debug");
    if (!"now" in Date) {
        Date.now = function() {
